      ...
      <div id="banner">
        <Container>
          <Row>
            <Col lg={8}>
              <h1>
                Ruang Coworking <br /> Tingkatkan Produktivitas.
              </h1>
            </Col>
            <Col lg={4}>
              <p className="banner-teks">
                Pilih tempat duduk yang terbuka, dan mulai bekerja Tingkatkan
            ...
            <div className="info-pembayaran mt-5">
              ...
              <Row className="mt-3">
                <Col lg={4}>
                  ...
                  <p>
                    Metode bayar yang dipilih: <b>{paymentMethod}</b>
                  </p>
                  <p>
                    Total Waktu: <b>{duration}</b> Jam{" "}
                    <b>(IDR {totalCost.toLocaleString()})</b>
                  </p>
                </Col>
              </Row>
            </div>
            <button className="btn btn-teal w-50 mt-3" type="submit">
              Reservasi
            </button>
          </form>
        </Container>
